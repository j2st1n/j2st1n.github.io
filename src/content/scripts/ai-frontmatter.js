...
module.exports = async (params) => {
  ...
  // 2. 32 个受控标签白名单
  const BLOG_TAGS = [
    "AI", "Agent", "Cloudflare", "Linux.do", "Obsidian", "OpenClaw",
    "安全", "博客", "出差", "读书", "公共领域", "工作流", "观察",
    "家庭", "健身", "教育", "科技", "历史", "旅行", "南渡北归",
    "生活", "生图", "社会", "赛里木湖", "思考", "随笔", "图床",
    "微信", "微信公众号", "新疆", "伊宁", "职场"
  ];
...
请阅读下面的博客正文草稿，为其提炼并输出以下字段（必须输出严格的 JSON 格式）：
